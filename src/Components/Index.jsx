        ...
        <div className="card-group">
          ...
          <div className="card mx-4 border-0 CardsBoda"  style={{ color: '#101010', border:'black',backgroundColor:' #F8E2DD' }}>
            ...
            <div className="card-body ">            
              ...
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'20px',marginTop:'10px'}}>2546</p>
            </div>
          </div>
          {/* CARD 2 BODA*/}
          <div className="card mx-4 border-0 CardsBoda" style={{ color: '#101010',backgroundColor:' #F8E2DD' }}>
            ...
            <div className="card-body">
              ...
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'30px',marginTop:'5px'}}>Boho Collection</p>
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'20px',marginTop:'10px'}}>2548</p>
            </div>
          </div>
          {/* CARD 3 BODA*/}
          <div className="card mx-4 border-0 CardsBoda" style={{color: '#101010',backgroundColor:' #F8E2DD' }}>
            ...
            <div className="card-body">
              ...
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'30px',marginTop:'-10px'}}>Boho Collection</p>
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'20px',marginTop:'10px'}}>2516</p>
            </div>
          </div>
          {/* CARD 4 BODA*/}
          <div className="card mx-4 border-0 CardsBoda" style={{ color: '#101010',backgroundColor:' #F8E2DD' }}>
            ...
            <div className="card-body">
              ...
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'30px',marginTop:'-10px'}}>Boho Collection</p>
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'20px',marginTop:'10px'}}>2593</p>
            </div>
          </div>        
        </div>
      </div>   
        ...
        <div className="card-group">
          ...
          <div className="card mx-4 border-0 CardsNoche"  style={{ color: '#101010', border:'black' }}>
            ...
            <div className="card-body ">              
              ...
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'30px',marginTop:'-10px'}}>Glam Collection</p>
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'20px',marginTop:'10px'}}>93</p>
            </div>
          </div>
          {/* CARD 2 NOCHE*/}
          <div className="card mx-4 border-0 CardsNoche" style={{ color: '#101010' }}>
            ...
            <div className="card-body">
              ...
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'30px',marginTop:'-10px'}}>Glam Collection</p>
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'20px',marginTop:'10px'}}>53</p>
            </div>
          </div>
          {/* CARD 3 NOCHE*/}
          <div className="card mx-4 border-0 CardsNoche" style={{color: '#101010' }}>
            ...
            <div className="card-body">
              ...
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'30px',marginTop:'-10px'}}>Glam Collection</p>
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'20px',marginTop:'10px'}}>59</p>
            </div>
          </div>
          {/* CARD 4 NOCHE*/}
          <div className="card mx-4 border-0 CardsNoche" style={{ color: '#101010' }}>
            ...
            <div className="card-body">
              ...
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'30px',marginTop:'-10px'}}>Glam Collection</p>
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'20px',marginTop:'10px'}}>92</p>
            </div>
          </div>        
        </div>
      </div>  
        ...
        <div className="card-group">
          ...
          <div className="card mx-4 border-0 CardsXV"  style={{ color: '#101010', border:'black' }}>
            ...
            <div className="card-body style ">              
              <img src="XV1.jpg" style={{  marginLeft:'-10px' ,width: '210px', height:'375px', borderradius:'90%',marginTop:'20px',marginBottom:'20px',marginLeft:'-20px' }} alt="Image" />                     
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'30px',marginTop:'-10px'}}>Princess Collection</p>
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'20px',marginTop:'10px'}}>3</p>
            </div>
          </div>
          {/* CARD 2 XV*/}
          <div className="card mx-4 border-0 CardsXV" style={{ color: '#101010' }}>
            ...
            <div className="card-body">
              ...
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'30px',marginTop:'-10px'}}>Princess Collection</p>
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'20px',marginTop:'10px'}}>8</p>
            </div>
          </div>
          {/* CARD 3 XV*/}
          <div className="card mx-4 border-0 CardsXV" style={{color: '#101010' }}>
            ...
            <div className="card-body">
              ...
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'30px',marginTop:'-10px'}}>Princess Collection</p>
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'20px',marginTop:'10px'}}>9</p>
            </div>
          </div>
          {/* CARD 4 XV*/}
          <div className="card mx-4 border-0" style={{ color: '#101010', backgroundColor:'' }}>
            ...
            <div className="card-body">
              ...
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'30px',marginTop:'-10px'}}>Princess Collection</p>
              <p style={{ color: '#101010',fontFamily:'EB Garamond', fontSize:'20px',marginTop:'10px'}}>10</p>
            </div>
          </div>        
        </div>
      </div>
